...
# Description: Implements a two-player zero-sum perfect information game with
# action, payoff, and actor information stored at each game state.
# Copied from CPSC 474 PSET 4
